...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            features::connections::commands::connection_duplicate,
            ...
            features::explain::commands::explain_capabilities,
            features::explain::commands::explain_measure,
            features::explain::commands::explain_plan,
            features::explain::commands::explain_raw,
            ...
            features::export::commands::save_text_file_atomic,
            ...
            features::schema_diff::commands::schema_snapshot,
            features::schema_diff::commands::schema_diff_compare,
            features::schema_diff::commands::schema_diff_apply,
            ...
            features::keyvalue::commands::kv_client_list,
            features::keyvalue::commands::kv_client_kill,
            features::keyvalue::commands::kv_client_kill_ids,
            features::keyvalue::commands::kv_client_no_evict,
            features::keyvalue::commands::kv_client_unpause,
            features::keyvalue::commands::kv_cluster_topology,
            ...
            features::dynamo::commands::dynamo_create_table,
            features::dynamo::commands::dynamo_delete_table,
            features::dynamo::commands::dynamo_truncate_table,
            ...
            features::mongo::commands::mongo_create_collection,
            features::mongo::commands::mongo_drop_collection,
            features::mongo::commands::mongo_truncate_collection,
            features::mongo::commands::mongo_empty_database,
            features::mongo::commands::mongo_drop_database,
            ...
            features::cassandra::commands::cassandra_drop_table,
            features::cassandra::commands::cassandra_drop_keyspace,
            features::cassandra::commands::cassandra_truncate_table,
            features::cassandra::commands::cassandra_empty_keyspace,

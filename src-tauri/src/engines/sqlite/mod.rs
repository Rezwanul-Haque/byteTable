...
mod tests {
    ...
    async fn open_empty(dir: &tempfile::TempDir) -> std::sync::Arc<dyn EngineConnection> {
    ...
    // --- M16 generate: end-to-end run_generation over a real SQLite schema ---
